  ...
  return (
    <section className="w-full my-6 id menu">
      <div className="w-full flex flex-col items-center justify-center">
            ...
            categories.map((item) => {
              return (
                <div
                  ...
                  } bg-gradient-to-tr from-orange-400 to-orange-600  hover:bg-gradient-to-tr hover:from-orange-600 hover:to-orange-400 cursor-pointer w-18 h-18 md:w-24 md:h-24 rounded-sm md:rounded-full min-w-[94px  shadow-lg  drop-shadow-lg flex flex-col gap-2 items-center justify-center duration-150 transition-all ease-in`}
                >
        ...
        <div className="w-full bg-gradient-to-tr rounded-lg from-orange-200 to-orange-600   mt-5">
          {!foodItems ? (
            <h1>Loading</h1>
          ) : (
            <RowContainer
